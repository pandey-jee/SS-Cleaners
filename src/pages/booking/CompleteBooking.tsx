          ...
          <CardContent className="pt-8 text-center">
            ...
            <div className="bg-blue-50 p-6 rounded-lg mb-6">
              ...
              <p className="text-lg font-semibold text-gray-700 mt-4">
                Total Amount: ₹{estimatedPrice.toLocaleString('en-IN')}
              </p>
            </div>

            <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg mb-6">
              <h3 className="font-semibold text-yellow-900 mb-3">💳 Complete Your Payment</h3>
            ...
            <div className="bg-muted p-6 rounded-lg text-left mb-6">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>💬 Chat with us anytime for questions</li>
              </ul>
            </div>
