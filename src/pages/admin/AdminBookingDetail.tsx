            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{booking.property_size_sqft} sq ft</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium">{booking.number_of_bathrooms}</p>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <p className="font-medium">{timeSlotLabels[booking.preferred_time_slot]}</p>
              </div>
            </CardContent>
          </Card>
