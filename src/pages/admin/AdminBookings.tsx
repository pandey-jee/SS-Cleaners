          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
            {Object.entries(statusLabels).map(([status, label]) => {
              ...
              const totalRevenue = bookings
                .filter((b) => b.booking_status === status)
              ...
              return (
                <Card key={status} className="text-center p-4">
                  ...
                  <p className="text-sm font-semibold text-green-600">${totalRevenue}</p>
                </Card>
              );
            })}
          </div>
            ...
            <Card className="bg-gradient-to-r from-green-50 to-green-100">
              <CardContent className="pt-6">
                ...
                <p className="text-3xl font-bold text-green-600">
                  ${bookings.reduce((sum, b) => sum + b.estimated_price, 0)}
                </p>
              </CardContent>
            </Card>
            <Card className="bg-gradient-to-r from-purple-50 to-purple-100">
              <CardContent className="pt-6">
                ...
                <p className="text-3xl font-bold text-purple-600">
                  ${bookings.length > 0 ? Math.round(bookings.reduce((sum, b) => sum + b.estimated_price, 0) / bookings.length) : 0}
                </p>
              </CardContent>
            </Card>
          </div>
                      ...
                      <TableCell>
                        <div className="text-sm">
                          ...
                          <p className="text-xs text-muted-foreground">
                            {booking.property_size_sqft} sqft • {booking.number_of_rooms}BR/{booking.number_of_bathrooms}BA
                          </p>
                        </div>
                      </TableCell>
                      <TableCell>
