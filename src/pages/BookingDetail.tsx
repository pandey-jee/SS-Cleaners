          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="lg:col-span-2 space-y-6">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-base font-semibold mt-1">{booking.property_size_sqft} sq ft</p>
                    </div>
                  </div>
                  <Separator />
                  <div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-base mt-1">{timeSlotLabels[booking.preferred_time_slot]}</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-base">{booking.enquiries.address}</p>
                  <p className="text-base">
                    {booking.enquiries.city}, {booking.enquiries.state} {booking.enquiries.zipcode}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span>{booking.enquiries.full_name}</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <Mail className="h-4 w-4 text-gray-400" />
                    <span>{booking.enquiries.email}</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <Phone className="h-4 w-4 text-gray-400" />
                    <span>{booking.enquiries.phone}</span>
                  </div>
                </CardContent>
              </Card>
